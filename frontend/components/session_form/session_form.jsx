...
class SessionForm extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.processForm(user).then(() => this.props.history.push("/collection/artists"));
    ...
    demoLogin(e) {
        ...
        this.props.processForm(demoUser).then(() => this.props.history.push("/collection/artists"));
    }
